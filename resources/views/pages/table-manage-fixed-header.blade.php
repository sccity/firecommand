...
@push('css')
	...
	<link href="/assets/plugins/datatables.net-fixedheader-bs5/css/fixedHeader.bootstrap5.min.css" rel="stylesheet" />
@endpush
...
@section('content')
	...
	<div class="row">
		...
		<div class="col-xl-2">
			...
			<p class="mb-20px">
				<a href="http://www.datatables.net/extensions/fixedheader/" target="_blank" class="btn btn-dark btn-sm">View Official Website</a>
			</p>
		</div>
		<!-- END col-2 -->
		<!-- BEGIN col-10 -->
		<div class="col-xl-10">
			...
			<div class="panel panel-inverse">
				...
				<!-- END panel-heading -->
				<!-- BEGIN alert -->
				<div class="alert alert-info alert-dismissible rounded-0 mb-0 fade show">
				...
				<div class="panel-body">
					<table id="data-table-fixed-header" width="100%" class="table table-striped table-bordered align-middle text-nowrap">
						<thead>
							<tr>
								<th width="1%">&nbsp;</th>
				...
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/table-manage/fixed-header.json"></code></pre>
				</div>
				<!-- END hljs-wrapper -->
			</div>
			<!-- END panel -->
