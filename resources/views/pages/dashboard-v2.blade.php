	...
	<div class="row">
		...
		<div class="col-xl-3 col-md-6">
			<div class="widget widget-stats bg-teal">
				...
				<div class="stats-content">
					<div class="stats-title">Weekly Average Response Time:</div>
					<div class="stats-number">2:46</div>
					<div class="stats-progress progress">
						<div class="progress-bar" style="width: 70.1%;"></div>
					</div>
					<div class="stats-desc">Better than last week (2:58)</div>
				</div>
			</div>
		</div>
		<!-- END col-3 -->
		...
		<div class="col-xl-3 col-md-6">
			<div class="widget widget-stats bg-blue">
				...
				<div class="stats-content">
					<div class="stats-title">Monthly Average Response Time:</div>
					<div class="stats-number">3:03</div>
					<div class="stats-progress progress">
						<div class="progress-bar" style="width: 40.5%;"></div>
					</div>
					<div class="stats-desc">Better than last month(40.5%)</div>
				</div>
			</div>
		</div>
		<!-- END col-3 -->
		...
		<div class="col-xl-3 col-md-6">
			<div class="widget widget-stats bg-indigo">
				...
				<div class="stats-content">
					<div class="stats-title">Calls This Month</div>
					<div class="stats-number">37</div>
					<div class="stats-progress progress">
						<div class="progress-bar" style="width: 76.3%;"></div>
					</div>
					<div class="stats-desc">Better than last month (51)</div>
				</div>
			</div>
		</div>
		<!-- END col-3 -->
		...
		<div class="col-xl-3 col-md-6">
			<div class="widget widget-stats bg-gray-900">
				...
				<div class="stats-content">
					<div class="stats-title">Monthly Avg Turnout Time</div>
					<div class="stats-number">0:55</div>
					<div class="stats-progress progress">
						<div class="progress-bar" style="width: 54.9%;"></div>
					</div>
					<div class="stats-desc">Better than last month (54.9%)</div>
				</div>
			</div>
		</div>
		<!-- END col-3 -->
