...
@section('content')
	...
	<div class="row">
		...
		<div class="col-xl-2">
			...
			<p class="mb-20px">
				<a href="http://www.datatables.net/extensions/select/" target="_blank" class="btn btn-dark btn-sm">View Official Website</a>
			</p>
		</div>
		<!-- END col-2 -->
		<!-- BEGIN col-10 -->
		<div class="col-xl-10">
			...
			<div class="panel panel-inverse">
				...
				<!-- END panel-heading -->
				<!-- BEGIN alert -->
				<div class="alert alert-lime alert-dismissible rounded-0 mb-0 fade show">
				...
				<div class="panel-body">
					<table id="data-table-select" width="100%" class="table table-striped table-bordered align-middle text-nowrap">
						<thead>
							<tr>
								<th width="1%"></th>
				...
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/table-manage/select.json"></code></pre>
				</div>
				<!-- END hljs-wrapper -->
			</div>
			<!-- END panel -->
