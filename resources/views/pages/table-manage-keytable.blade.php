...
@section('content')
	...
	<div class="row">
		...
		<div class="col-xl-2">
			...
			<p class="mb-20px">
				<a href="http://www.datatables.net/extensions/keytable/" target="_blank" class="btn btn-dark btn-sm">View Official Website</a>
			</p>
		</div>
		<!-- END col-2 -->
		<!-- BEGIN col-10 -->
		<div class="col-xl-10">
			...
			<div class="panel panel-inverse">
				...
				<div class="hljs-wrapper">
					<pre><code class="html" data-url="/assets/data/table-manage/keytable.json"></code></pre>
				</div>
				<!-- END hljs-wrapper -->
			</div>
			<!-- END panel -->
